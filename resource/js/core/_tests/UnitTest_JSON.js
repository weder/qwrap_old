...
describe('JSON', {
	...
	'表达式': function() {
		/*该用例在Firefox3.5与IE8下抛异常，在Chrome下按照表达式进行计算*/
	...
	'对象-reviver3': function() {
		...
		if( !isNaN(obj.key2.key21) )
			value_of(this).should_fail('obj的值应该是NaN');
	},
...
describe('JSON.stringify', {
	...
	'日期': function() {
		/*该用例在Firefox3.5中会计算毫秒值，结果为"2009-12-31T15:59:59000Z"，在IE8与Chrome下为"2009-12-31T15:59:59Z"*/
	...
	'UNDEFINED': function() {
		/*该用例在IE中返回的是字符串"undefined"，在Firefox与Chrome中返回的是undefined*/
		var obj = undefined;
		var objString = JSON.stringify(obj);
	...
	'对象-function replacer1': function() {
		/*该用例在IE8与Chrome中测试通过，在Firefox3.5中测试失败*/
		var obj = {key1:[1,2,3,{key11:[1,2,3,{key111:'hello world'}]}]};
	...
	'对象-function replacer2': function() {
		/*该用例在IE8与Chrome中测试通过，在Firefox3.5中测试失败*/
		var obj = {key1:[1,2,3,{key11:[1,2,3,{key111:'hello world'}]}]};
		var objString = JSON.stringify(obj,function(k,v){
			if( k == 'key111' )
	...
	'对象-function replacer5': function() {
		/*该用例在IE8与Chrome中测试通过，在Firefox3.5中测试失败*/
		var obj = {key1:[1,2,3,{key11:[1,2,3,{key111:'hello world'}]}]};
		var objString = JSON.stringify(obj,function(k,v){
			if( k == 'key111' )
	...
	'对象-function replacer6': function() {
		/*该用例在IE8与Chrome中测试通过，在Firefox3.5中测试失败*/
		var obj = {key1:[1,2,3,{key11:[1,2,3,{key111:'hello world'}]}]};
		var objString = JSON.stringify(obj,function(k,v){
			if( k == 'key111' )
