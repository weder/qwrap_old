(function() {
	...
	document.write(
		  '<script type="text/javascript" src="'+srcPath+'components/animation/anim.manager.js"></script>'
		...
		, '<script type="text/javascript" src="'+srcPath+'components/animation/anim.h.js"></script>'
	);
})();